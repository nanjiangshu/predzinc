...
#define MAX_NUM_PDB          80000// maximal number of entries of PDB
#define MAX_NUM_NRPDB        10000 // maximal number of entries of nrPDB
#define MAX_NRPDB_LIST       10000 // maximal number of chains in nrPDB list
